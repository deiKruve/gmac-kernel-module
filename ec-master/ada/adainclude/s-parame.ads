...
--  this is a try at defining System.Parameters for a kernel runtime
--  it might be wildly off the mark. (j.d.k)
...
package System.Parameters is
   ...
   Default_Stack_Size : constant Size_Type := 2 * 4096;
   --  Default task stack size used if none is specified
   --  this value is kernel stacksize for 32 bit,
   --  for 64 bit it might well be 4 * 4096; but lets play safe;
   --   https://www.kernel.org/doc/Documentation/x86/x86_64/kernel-stacks
   --    arch/x86/include/asm/page_32_types.h
   --    arch/x86/include/asm/page_64_types.h
   --     in the kernel headers

   Minimum_Stack_Size : constant Size_Type := 1024;
