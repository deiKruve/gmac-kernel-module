...
package x86_64_linux_gnu_bits_ioctl_types_h is
  ...
  -- Get definition of constants for use with `ioctl'.   
   ...
   pragma Convention (C_Pass_By_Copy, winsize);  -- /usr/include/x86_64-linux-gnu/bits/ioctl-types.h:27
  ...
  -- input mode flags  
   ...
   type termio is record
      ...
      c_cc : aliased termio_c_cc_array;  -- /usr/include/x86_64-linux-gnu/bits/ioctl-types.h:43
   end record;
   pragma Convention (C_Pass_By_Copy, termio);  -- /usr/include/x86_64-linux-gnu/bits/ioctl-types.h:36
